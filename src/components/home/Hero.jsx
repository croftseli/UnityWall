  ...
  return (
    <>
        ...
        <div className="relative z-10 flex items-end justify-center md:justify-start h-screen px-4 md:pl-16 pb-10 md:pb-32 md:pr-0 pointer-events-none">
          <div className="flex flex-col md:flex-row items-center md:items-center space-y-4 md:space-y-0 md:space-x-16 w-full max-w-5xl">
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="box pointer-events-none relative text-center md:text-left w-full"
            >
              <motion.img
              ...
              <div className="title flex flex-col items-center md:block">
                ...
                <motion.div
                  ...
                  className="text-wrapper mt-2 md:mt-0 md:!top-[60px] text-4xl sm:text-5xl md:text-6xl lg:text-7xl"
                >
              ...
              <motion.div
                variants={heroChildVariants}
                className="p whitespace-normal leading-relaxed text-sm md:text-base max-w-full xs:max-w-xs sm:max-w-sm md:max-w-md lg:max-w-[560px] mx-auto md:mx-0 mt-4 md:mt-0"
              >
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="hidden md:block pointer-events-auto md:ml-8"
            >
              <Link href="/clients" passHref>
      ...
      <div className="bg-gray-700 text-white py-20 px-4 sm:px-8 lg:px-16 xl:px-24 relative overflow-hidden">
        ...
        >
          <motion.h3 variants={sectionChildVariants} className="cta-title">Ready to Start Your Project?</motion.h3>
          ...
          <motion.div variants={sectionChildVariants} className="pointer-events-auto">
